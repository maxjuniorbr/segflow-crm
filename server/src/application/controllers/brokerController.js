...
export const getBrokerById = async (req, res) => {
    try {
        const result = await getBrokerByIdUseCase(req.params.id);
        res.status(result.status).json(result.payload);
    } catch (err) {
...
export const createBroker = async (req, res) => {
    try {
        const result = await createBrokerUseCase(req.body);
        res.status(result.status).json(result.payload);
    } catch (err) {
...
export const updateBroker = async (req, res) => {
    try {
        const result = await updateBrokerUseCase(req.params.id, req.body);
        res.status(result.status).json(result.payload);
    } catch (err) {
...
export const deleteBroker = async (req, res) => {
    try {
        const result = await deleteBrokerUseCase(req.params.id);
        res.status(result.status).json(result.payload);
    } catch (err) {
